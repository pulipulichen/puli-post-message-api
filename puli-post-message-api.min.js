...
else if("popup"===l){n=void 0;c&&c.target&&(n=c.target);let b=void 0;c&&c.features&&(b=c.features);m=window.open(a,n,b)}b=await B(function(){m||"iframe"!==l||(m=h.contentWindow);return m},a,d,b);!0===f?("iframe"===l?h&&h.parentNode.removeChild(h):m.close(),delete p[a],delete g[a]):g[a]||(g[a]=m);"function"===typeof e&&e(b);return b},addReceiveListener:function(a,b){"function"!==typeof a||b||(b=a,a="_default");if("function"!==typeof b)return!1;q[a]=b},removeReceiveListener:function(a,b){"function"!==
typeof a||b||(b=a,a="_default");if("function"!==typeof b||!q[a])return!1;delete q[a]},ready:function(){u()}}};